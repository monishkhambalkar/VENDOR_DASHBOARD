...
const SignUp: React.FC = () => {
  ...
  const [userTypeValidation, setUserTypeValidation] = useState(false);
  ...
  const handleSubmit = async (event) => {
    ...
    setNameValidation(formData.sName == "" ? true : false);
    setEmailValidation(formData.sEmail == "" ? true : false);
    setPasswordValidation(formData.sPassword == "" ? true : false);
    setUserTypeValidation(formData.sUserType == "" ? true : false);

    try {
      const apiUrl = `${config.VENDOR_BASE_URL}/user/register`;
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <p className="2xl:px-20">
                Create Your Account For Expand Your Business
              </p>
